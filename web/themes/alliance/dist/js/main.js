...
const clientsMarquee = document.querySelector(".our-clients__marquee .swiper");
if (clientsMarquee) {
  const clientsMarqueeBody = new Swiper(clientsMarquee, {
    loop: true,
    centeredSlides: "auto",
    spaceBetween: 30,
    speed: 8000,
...
Marquee(".our-clients__marquee", 0.5);
